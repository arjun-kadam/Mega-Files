...
public class AuthController {
    ...
    public ResponseEntity<?> signup(@RequestBody SignupRequest signupRequest){
        ...
        UserDTO createUseDto=authenticationService.signup(signupRequest);
        if (createUseDto==null){
    ...
    public ResponseEntity<JwtAuthResponse> signIn(@RequestBody RefreshTokenRequest refreshTokenRequest){
